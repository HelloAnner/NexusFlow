...
export default function SAAdminPage() {
  ...
  return (
    <MainLayout title="管理后台" subtitle="平台级运营与监控">
      <div className="grid min-h-[calc(100vh-156px)] grid-cols-[260px_1fr] gap-3">
        <aside className="flex min-h-0 shrink-0 flex-col rounded-md border border-border-subtle bg-bg-secondary p-3">
          ...
          <div className="mt-2 flex items-center gap-3 border-t border-border-subtle pt-3">
            <Avatar name="超级管理员" className="h-8 w-8" />
        ...
        <div className="flex min-w-0 flex-1 flex-col gap-4 rounded-md border border-border-subtle bg-bg-secondary p-4">
